...
description: Cómo iniciar sesión en Agentic A8n Hub con Auth0 (SSO o email), elegir un tenant y orientarte en tu primera visita.
...
Esta guía te lleva paso a paso por el primer inicio de sesión en Agentic A8n Hub, la selección de tu organización (tenant) y cómo aprovechar al máximo tu primera experiencia en el dashboard.

---

## Iniciar sesión con Auth0

Agentic A8n Hub usa **Auth0** para la autenticación. Podés iniciar sesión con:
...
1. Abrí la URL de Agentic A8n Hub que te dio tu organización (ej. `https://your-tenant.a8n-hub.app` o el dominio personalizado de tu empresa).
...
5. Después de autenticarte, te redirigen de vuelta a Agentic A8n Hub.

> **Tip:** Si no ves la opción de inicio de sesión que esperás, tu tenant puede tener solo SSO o conexiones específicas habilitadas. Contactá a tu admin de Agentic A8n Hub o a IT por el método correcto.

---

## Selección de tenant (varias organizaciones)

Si pertenecés a **más de una organización** (tenant) en Agentic A8n Hub, después del login tenés que elegir en cuál trabajar.
...
5. **Guardá la documentación** — Tené a mano [Bienvenido a Agentic A8n Hub](/docs/es/getting-started) y las guías por rol para consultar mientras explorás.

Si tenés problemas con el login (tenant incorrecto, SSO faltante, cuenta bloqueada), contactá a tu **administrador de Agentic A8n Hub** o al soporte de IT de tu organización.

---

## Seguridad y sesiones

- **Duración de la sesión** — Cuánto tiempo permanecés logueado depende de la configuración de Auth0 y Agentic A8n Hub de tu tenant. Puede pedírsete iniciar sesión de nuevo tras un tiempo de inactividad o tras un plazo fijo.
- **Cerrar sesión** — Usá el menú de cuenta (tu avatar o nombre en el encabezado) y elegí **Cerrar sesión**. Vas a tener que iniciar sesión de nuevo para acceder a Agentic A8n Hub.
- **Varios dispositivos** — Podés usar Agentic A8n Hub en más de un dispositivo. Cada sesión sigue las mismas reglas de seguridad y timeout. Cerrá sesión en dispositivos compartidos cuando termines.
- **Contraseña y MFA** — Los cambios de contraseña y la autenticación multifactor se gestionan en Auth0 (o tu proveedor SSO). Si necesitás restablecer la contraseña o actualizar MFA, usá el enlace de la página de login o contactá a IT o a tu admin de Agentic A8n Hub.
