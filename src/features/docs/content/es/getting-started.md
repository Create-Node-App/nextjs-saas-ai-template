...
| **Capacidades**          | Conjuntos de habilidades requeridas para un rol o función. Se usan en perfiles de rol, roadmaps y análisis de brechas.                           |
| **OKRs**                 | Objetivos y Resultados Clave. Metas personales y de equipo con check-ins y seguimiento de progreso.                                              |
| **Desempeño**            | Ciclos de desempeño, autoevaluaciones, evaluaciones del supervisor y feedback, muchas veces acotados a proyectos o líneas de reporte.            |
| **Base de conocimiento** | Lugar central para documentación interna, guías y políticas. Se puede buscar y enlazar desde la plataforma.                                      |

Entender estos conceptos facilita usar las guías de Miembro, Manager, 1:1 y Admin.
...
| ------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Miembro**         | Todos                                          | Tu perfil, habilidades, OKRs, aprendizaje, desempeño, proyectos, Buscador de personas, Base de conocimiento, feedback y reconocimiento, y asistente de IA.                 |
| **Manager**         | Quienes gestionan a otros en el organigrama    | Todo lo de Miembro, más dashboard de equipo, reportes, evaluaciones de desempeño de reportes, asignaciones de aprendizaje, OKRs de equipo y herramientas de reuniones 1:1. |
| **Facilitador 1:1** | Quienes conducen 1:1 (pueden o no ser manager) | Una vista 1:1 dedicada: personas con las que facilitás 1:1s, reuniones y acceso de solo lectura a su desempeño y proyectos.                                                |
| **Admin**           | Administradores del tenant                     | Acceso completo: miembros e invitaciones, habilidades y capacidades, perfiles de rol, roadmaps, roles y permisos, configuración, integraciones y análisis.                 |

> **Tip:** Manager y Facilitador 1:1 son **distintos**. Podés ser facilitador 1:1 de alguien sin ser su manager, y viceversa. El organigrama se basa en la relación "manager"; la vista 1:1 se basa en las relaciones "facilitador 1:1".
...
- **¿Nuevo en la plataforma?** → [Primer inicio de sesión](/docs/es/getting-started/first-login) y [Navegación y vistas](/docs/es/getting-started/navigation).
- **Configurar tu perfil** → [Configuración del perfil](/docs/es/getting-started/profile-setup).
- **Miembro (tu propio crecimiento)** → Guía Miembro: dashboard, evaluación de habilidades, aprendizaje, OKRs, desempeño, proyectos, Buscador de personas, Base de conocimiento, feedback y asistente de IA.
- **Manager (equipo y reportes)** → Guía Manager: dashboard de equipo, proyectos y clientes, evaluaciones de desempeño, asignaciones de aprendizaje, OKRs de equipo y reuniones 1:1.
